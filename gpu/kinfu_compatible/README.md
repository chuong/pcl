This folder contains modified codes to make Kinfu comparable to KinectFusion with noise model. The results were included in the following videos as KinectFusion (without noise modeling).
